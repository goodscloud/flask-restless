...
class TestHeaders(TestSupportPrefilled):
    ...
    def test_accept(self):
        ...
        assert b'id="1"' in response.data, response.data
...
class TestXML(TestSupport):
    ...
    def test_to_one_relation(self):
        ...
        assert 'id' in manufacturer_elem.attrib.keys(), manufacturer_elem.attrib.keys()
    ...
    def test_to_many_relation(self):
        ...
        assert len([e for e in models_elem]) == 2, len([e for e in models_elem])
